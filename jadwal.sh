# Mao recode?? ya silahkan
#Gak ada guna lu recod hanya untuk kepentingan Yg tidak2
#silahkan Belajar mamank
#AdzanLight
...
function banner(){
	...
	echo -e "\t${p}      Author: ${pu}AdzanLight  ${m}v.1.0${p}"
	echo -e "\t    Team: NewbieTester"
...
function about(){
echo -e "
        ${h}[ ${p}BIG FAMILY •NEWBIE TESTER ID• ${h}]${p}
        
        [${h}+${p}] - Raden_Ar
 	[${h}+${p}] - Dry_Chappie
	[${h}+${p}] - AdzanLight
	[${h}+${p}] - MrChell
	[${h}+${p}] - CNC | Lupa Nama Gua:V
	[${h}+${p}] - CNC MARLEX
	[${h}+${p}] - Danz
	[${h}+${p}] - UserJ
	[${h}+${p}] - ./Hezal
...
printf "\n${h}              ~ ~  ┌${p1}∩${h}┐${k}(${m}◣${p1}_${m}◢${k})${h}┌${p1}∩${h}┐  ~ ~\n"
printf "              ${p}[${h}•${p}]${p} TerimaKasih*_* ${p}[${h}•${p}]${k}\n"
sleep 1
exit 1
